...
from models import GAT_BNF, GAT_bi_BNF, GAT_AE_BNF, GAT_AE_BNF_V2
...
while(True):
    ...
    for train_ind, test_ind in kf.split(fmri_signals):
        ...
        with tf.Graph().as_default():
            ...
            logits, reconstruct_fmri, reconstruct_DTI, prediction, cam_map = model.inference(ftr_in, nb_classes, fmri_net, nb_CAM, is_train,
            ...
            with tf.Session() as sess:
                ...
                for epoch in range(nb_epochs):
                    ...
                    while tr_step * batch_size < tr_size:
                        _, loss_value_tr, acc_tr, observation = sess.run([train_op, loss, accuracy, reconstruct_fmri],
    ...
    ###---------------------------------------------------------------------------------------------
                ...
                while ts_step * batch_size < ts_size:
                    loss_value_ts, acc_ts, recon_net, original_net, predict_label, actual_label = sess.run([loss, accuracy,reconstruct_fmri,fmri_net, prediction, lbl_in],
                        feed_dict={
                ...
                while tr_step * batch_size < tr_size:
                    _, loss_value_tr, acc_tr, cam = sess.run([train_op, loss, accuracy, cam_map],
