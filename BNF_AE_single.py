...
recon_lr_weight = 10
hid_units = [32,32] # numbers of hidden units per each attention head in each layer
n_heads = [12, 12] # additional entry for the output layer
residual = True
...
while(True):
    ...
    for train_ind, test_ind in kf.split(fmri_signals):
        ...
        with tf.Graph().as_default():
            ...
            logits, reconstruct_fmri, reconstruct_DTI, prediction = model.inference(ftr_in, nb_classes, fmri_net, nb_CAM, is_train,
    ...
    ###---------------------------------------------------------------------------------------------
                    ...
                    if val_acc_avg/vl_step >= vacc_mx or val_loss_avg/vl_step <= vlss_mn:
                        ...
                        curr_step += 1
                        if (curr_step == patience or train_acc_avg/tr_step>0.92) and epoch>30:
