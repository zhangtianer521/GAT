...
while(True):
    ...
    with tf.Graph().as_default():
        ...
        loss = model.BNCNN_syn_loss(logits, lbl_in)

        accuracy = model.BNCNN_syn_accuracy(logits, lbl_in)
...
###---------------------------------------------------------------------------------------------
                ...
                if val_acc_avg/vl_step >= vacc_mx or val_loss_avg/vl_step <= vlss_mn:
                    ...
                    curr_step += 1
                    if curr_step == patience and train_acc_avg/tr_step>0.9:
            ...
            while ts_step * batch_size < ts_size:
                loss_value_ts, acc_ts, predict_label, actual_label, tMAE, tMSE = sess.run([loss, accuracy, predict, lbl_in, G_MAE, G_MSE],
                    feed_dict={
            ...
            print('Test loss:', ts_loss / ts_step, '; Test accuracy:', ts_acc / ts_step, '; MSE: ', ts_MSE / ts_step,
                  '; MAE: ', ts_MAE / ts_step)
...
#
# if(test_acc_avg>0.58 and test_acc_avg<0.64):
